...
description: 
    Download segmentation from Ariadne
'''
import zarr
import numpy as np
...
def load_and_write_chunk(slices, toml_path, output_zarr_path, mag_size, downsampled_size):
    ...
    # Load the segmentation data with retry logic
...
if __name__ == "__main__":
    ...
    toml_path = '/home/zhangy8@hhmi.org/Desktop/mitos.streaming.k.toml'
    output_zarr_path = "/media/zhangy8/ca0155b9-932b-4491-8ea9-d40a586475cf/SegmentationData/source/mitochondria_seg_mag2_20250206.zarr"
    total_volume_size = (27491, 15255,12548)
    chunk_size= (1024, 1024, 1024)  # Adjust based on memory limit
    mag_size = 2
